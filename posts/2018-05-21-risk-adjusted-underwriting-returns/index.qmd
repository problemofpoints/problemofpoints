...
![source: Bloomberg](risk-adjusted-coc.png
...
![](risk-adjusted-buyback-return.png)
...
![Assumptions: 2% investment yield; 35% tax rate on underwriting income, 15% tax rate on investment income](risk-adjusted-answer1.png)

![](risk-adjusted-answer2.png)
