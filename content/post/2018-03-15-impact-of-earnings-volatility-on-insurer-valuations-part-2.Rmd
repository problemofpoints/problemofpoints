...
subtitle: "ROE vs. spread over cost of equity"
date: 2018-03-15
...
fit_pb_roae_eps <- stan_glmer(p_to_tbv ~ 1 + (1 + spread + spread:high_vol2 | sector),
                          family = Gamma(link = "identity"),
                          prior = student_t(df = 3, location = 0, scale = 2.5),
                          prior_intercept = student_t(df = 3, location = 0, scale = 2.5),
