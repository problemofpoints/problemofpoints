...
run_causal_impact <- function(stock_data, prior_level_sd = 0.05, use_dynamic = FALSE){
  ...
  impact_analysis <- CausalImpact(model_data_mat,
                                  ...
                                  model.args = list(niter = 1000, prior.level.sd = prior_level_sd, dynamic.regression = use_dynamic))
...
impact_model <- run_causal_impact(stock_prices %>% filter(symbol == "XL"), 0.05, FALSE)
